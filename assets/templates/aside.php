...
?>
		...
		<?php if ( 'on' != get_option('dtjwpt_donate_upsell') ) : ?>
			...
			<div class="dtjwpt-box">
				...
				<div class="dtjwpt-content">
					...
					<p><a href="https://profiles.wordpress.org/lumiblog/#content-plugins" target="_blank"><?php _e('Check out my other plugins.', 'wp-triage'); ?></a></p>

					<p><a href="https://wpcorner.co//donate" class="button button-primary" target="_blank"><?php _e('Donate Now', 'wp-triage'); ?></a></p>
	...
	<div class="dtjwpt-box">
		...
		<h3 class="dtjwpt-title"><?php _e('Support', 'wp-triage'); ?></h2>
